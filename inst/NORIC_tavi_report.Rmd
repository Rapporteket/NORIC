...
# Ventetid TAVI
Ventetetid ved TAVI beregnes som antall dager fra dato for screeningbeslutning 
og prosedyredato. 

Figuren viser et boxplot med fordeling av 
...
```{r figVentetid, cap =cap, fig.width = 8, fig.height = 5,  fig.pos = "H", fig.align = "center", out.width = "\\textwidth"}

cap <- paste0("Ventetid ved TAVI er beregnet som antall dager mellom ", 
              "Screening besluting og proseydre. ")
AK %>% 
