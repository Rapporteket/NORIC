...
AK %<>% 
  dplyr::mutate(
    ...
    TypeKlaffeprotese2 = dplyr::recode(
      TypeKlaffeprotese,
      "CoreValve" = "Evolut",
      "CoreValve Evolut R" = "Evolut",
      "CoreValve Evolut PRO" = "Evolut",
      "Evolt FX pluss" = "Evolut",
      "Evolut FX" = "Evolut",
      "Evolut FX Plus" = "Evolut",
      "Evolut FX pluss"= "Evolut",
      "Edwards" = "Sapien",
      "Edwards RESILIA" = "Sapien",
      "Edwards SAPIEN 3" = "Sapien",
      "Edwards SAPIEN 3 Ultra" = "Sapien",
      "Edwards SAPIEN 3 Ultra RESILIA" = "Sapien", 
      "Edwards SAPIEN XT" = "Sapien",
      "NAVITOR" = "Navitor",
      "Meril Myval Octacor" = "Myval",
      "Meril Myval Octapro" = "Myval",
      "Annen" = "Annen",
      .missing = "Missing",
      .default = "Annet"),
    
    
    TypeKlaffeprotese2 = forcats::fct_relevel(
      TypeKlaffeprotese2,
      c("Evolut", "Sapien", "Navitor", "Myval", "Annen", "Missing", "Annet")), 
...
TabHast_fjor <- merge(
  x = timeTableMonth_fjor,
  y = AK %>%  
    janitor::tabyl(maaned, Hastegrad) %>% 
    janitor::adorn_totals("col", name= "Totalt"), 
  by.x  = "maaned", 
  by.y = "maaned", 
  all.x = TRUE) %>% 
...
TabTypeKlaff_fjor <- merge(
  ...
  y = AK %>%  
    filter(Prosedyre %in% c("TAVI")) %>% 
    janitor::tabyl(maaned, TypeKlaffeprotese2, show_missing_levels = FALSE) %>% 
    janitor::adorn_totals("col", name= "Totalt"), 
  by.x  = "maaned", 
  by.y = "maaned", 
  all.x = TRUE) %>% 
...
query <- paste0(
 ...
 WHERE 
   ...
   mce.INTERDAT <= '", toDate, "'  AND 
   mce.CENTREID = '", params$reshId, "' ; ")
