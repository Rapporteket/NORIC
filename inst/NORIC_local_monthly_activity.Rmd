...
t_TabAngiografor <-  t_TabAngiografor[-1,]
...
tab_pciOperator <- angiografor_AP %>% 
  janitor::tabyl(maaned,
...
t_TabPciOperator <- transpose(TabPciOperator)
rownames(t_TabPciOperator) <- colnames(TabPciOperator) 
colnames(t_TabPciOperator) <- TabPciOperator[,1]
t_TabPciOperator <-  t_TabPciOperator[-1,]

t_TabPciOperator[t_TabPciOperator == 0] <- " - "
t_TabPciOperator[is.na(t_TabPciOperator)] <- " - "

align <- c(rep("r", dim(t_TabPciOperator)[2]))
...
align <- c("l", rep("c", dim(t_TabPciOperator)[2] - 1))
