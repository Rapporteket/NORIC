...
if(params$tableFormat == "html") {
  ...
  ". Rapporten er kun ment til internt bruk! Rapporten inneholder tabeller med resultater basert på forløp registrert ved ", 
    params$hospitalName,
    ". Opptellinger og statistikker er gjort per forløp/prosedyre, og ikke per individ. Tabellene presenteres med de siste 14 månedene.",
    HTML("<br/><br/>"),
