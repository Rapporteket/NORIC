...
TabAngiografor_aar <- merge(
  ...
  by.y = "maaned",
  all.x = TRUE) %>%
  janitor::adorn_totals("row", name = paste("Totalt i", periode_data$nyesteRegYear, sep = "\n"))
...
align <- c(rep("c", dim(t_TabAngiografor)[2]))
...
if (params$tableFormat == "html") {
  t_TabAngiografor %>%
    ...
    kableExtra::kable_styling(bootstrap_options = c("striped",
                                                    ...
                                                    "condensed"),
                              full_width = FALSE) %>%
    kableExtra::row_spec(row = 0, font_size = 10, bold = TRUE, angle = -45) %>%
    ...
    kableExtra::add_header_above(., header = c("",
                                               setNames(13, periode_data$sisteHeleYear),
                                               setNames((ncol(t_TabAngiografor)-13), periode_data$nyesteRegYear)),
                                 bold = TRUE,
                                 font_size = 12)
  ...
  knitr::kable(format = params$tableFormat,
    ...
    kableExtra::kable_styling(latex_options = c("HOLD_position",
                                                "scale_down")) %>%
    kableExtra::row_spec(row = 0, font_size = 10, bold = TRUE, angle = 90) #%>%
    # kableExtra::column_spec(column = 14,
    #                         border_right = TRUE) %>% 
    # kableExtra::column_spec(column = (ncol(t_TabAngiografor)+1),
    #                         border_right = TRUE) %>% 
