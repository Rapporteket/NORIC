...
AP %<>% mutate(
  ...
  forkortetNavnAngiografor = if_else(.data$Angiografor1 %in% c("Ukjent"),
  ...
  forkortetNavnPCIoperator = if_else(.data$PCIHovedOperator %in% c("Ukjent"),
...
tab_angiografor <- angiografor_AP %>% 
  janitor::tabyl(.data$forkortetNavnAngiografor,
                 .data$maaned,
...
tab_pciOperator <- pciOperator_AP %>% 
  janitor::tabyl(.data$forkortetNavnPCIoperator,
                 .data$maaned,
                 show_missing_levels = FALSE) %>% 
  janitor::adorn_totals("col", name = "Totalt") %>% 
  janitor::adorn_totals("row", name = "Totalt") %>% 
