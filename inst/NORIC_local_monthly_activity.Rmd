...
TabPciOperator %<>%
  rename(paste0("Totalt i ", periode_data$sisteHeleYear) = "tot_fjor",
         paste0("Totalt hittil i ", periode_data$nyesteRegYear) = "tot_fjor")
...
if (params$tableFormat == "html") {
  TabPciOperator %>% rename(" " = "forkortetNavnPCIoperator") %>%
    ...
    # kableExtra::column_spec(column = 14,
    #                         background = "#EBEBEB") %>%
    # kableExtra::column_spec(column = (ncol(TabPciOperator)+1),
    #                         background = "#EBEBEB") %>%
    # kableExtra::add_header_above(
    #   .,
    #   header = c("",
    #              setNames(13,
    #                       periode_data$sisteHeleYear),
    #              setNames((ncol(TabPciOperator)-13),
    #                       periode_data$nyesteRegYear)),
    #   bold = TRUE,
    #   font_size = 12)
