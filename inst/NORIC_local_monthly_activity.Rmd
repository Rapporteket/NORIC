...
<br/> <br/>
Rapporten inneholder tabeller med resultater basert på forløp registrert ved `r params$hospitalName`. Opptellinger er gjort per forløp/prosedyre, og ikke per individ. Tabellene presenteres med data fra de siste 14 månedene.
<br/> <br/>
