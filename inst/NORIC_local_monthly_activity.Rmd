...
AP %<>% mutate(
  forkortetNavnAngiografor = if_else(is.na(Angiografor1),
                                     true = NA_character_,
                                     false = paste0(
                                       substr(stringr::word(AP$Angiografor1, 1), 1, 1),
                                       ". ",
                                       stringr::word(AP$Angiografor1, -1))),
  
    forkortetNavnPCIoperator = if_else(is.na(PCIHovedOperator),
                                     true = NA_character_,
                                     false = paste0(
                                       substr(stringr::word(AP$PCIHovedOperator, 1), 1, 1),
                                       ". ",
                                       stringr::word(AP$PCIHovedOperator, -1)))
)
...
tab_angiografor <- addmargins(xtabs(
  formula = ~ forkortetNavnAngiografor + maaned,
  data = angiografor_AP,
...
tab_pciOperator <- addmargins(xtabs(
  formula = ~ forkortetNavnPCIoperator + maaned,
  data = pciOperator_AP,
  drop.unused.levels = TRUE))
