...
* __Stentbruk__: Inneholder opplysninger om hvilke stenter som er brukt.

* __Prosedyrer__: Opptellinger relatert til utførte prosedyrer fra 
_Andre prosedyrer_ - og _AngioPCI_-modulen.


#### Aktivitet
Denne rapporten inneholder opptellinger av angiograførenes og operatørenes aktivitet. Rapporten er kun tilgjengelig pålogget lokalt som SC-bruker.
For automatisk tilsending av rapportene per e-post se Abonnement.
