...
## Day of the week of first hopsitalisation after symptom onset
AP$WeekDay <- format(
#    x = AP$ProsedyreDato ,
    x = AP$InnleggelseHenvisendeSykehusDato ,
    format = "%a")
...
<<Fig-R-NSTEMI-transferred-Delay-Weekday,fig.cap="Prosentandel NSTEMI i ventetidkategorier per ukedag av innleggelse i henvisende sykehus.",fig.width=14,fig.height=7,out.width="\\textwidth">>=
...
\begin{frame}[fragile]
    \frametitle{dager fra indeks innleggelse til prosedyre}

<<Fig-R-NSTEMI-Delay-Weekday-by-status-year,fig.cap="Prosentandel NSTEMI i ventetidkategorier per ukedag av innleggelse i henvisende sykehus.",fig.width=14,fig.height=7,out.width="\\textwidth">>=

par( mfrow = c(2,3) )

TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = HenvisningsStatus  ==  "Direkte" & ( Year == 2014 ) ,
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2014\nDirekte" , cex = 5 , pos = 3 , col ="#84848488")

TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = HenvisningsStatus  ==  "Direkte" & (Year == 2015 ) ,
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2015\nDirekte" , cex = 5 , pos = 3 , col ="#84848488")
...
TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = HenvisningsStatus  ==  "Direkte" & (Year == 2016 ),
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2016\nDirekte" , cex = 5 , pos = 3 , col ="#84848488")
...
TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = HenvisningsStatus  ==  "Overflyttet" & (Year == 2014 ),
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2014\nOverflyttet" , cex = 5 , pos = 3 , col ="#84848488")

TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = HenvisningsStatus  ==  "Overflyttet" & (Year == 2015 ),
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2015\nOverflyttet" , cex = 5 , pos = 3 , col ="#84848488")
...
TabNDelay <- xtabs(
    formula = ~ DelayFromIndexAdmissionToProcedure + WeekDay ,
    subset = (HenvisningsStatus  ==  "Overflyttet") & (Year == 2016 ) ,
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2016\nOverflyttet" , cex = 5 , pos = 3 , col ="#84848488")
...
<<Fig-R-NSTEMI-Delay-Weekday-by-year,fig.cap="Prosentandel NSTEMI i ventetidkategorier per ukedag av index innleggelse (alle NSTEMI, både henvist og direkte innlagt i PCI sykehus.",fig.width=14,fig.height=7,out.width="\\textwidth">>=
...
TabNDelay <- xtabs(
    ...
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2014" , cex = 5 , pos = 3 , col ="#84848488")
...
TabNDelay <- xtabs(
    ...
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2015" , cex = 5 , pos = 3 , col ="#84848488")
...
TabNDelay <- xtabs(
    ...
    data = NSTEMI)
BarplotTable( TabNDelay )
text( 4 , 0 , "2016" , cex = 5 , pos = 3 , col ="#84848488")
