...
mst(TabNStentType, params$tableFormat, cap, 0, lsd = TRUE)
...
mst(tab, params$tableFormat, cap, 1, lsd = TRUE)
...
mst(PrettyTabNR( TabNProsedyreType ), params$tableFormat, cap, 0, lsd = TRUE)
# print(
#     xtable::xtable(
...
```{r Barplot_Nstent_per_Prosedyre,fig.width=12,fig.height=8,out.width="4in"}
