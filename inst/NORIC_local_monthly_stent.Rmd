...
```{r N_stents_StentType_YearMonth,fig.cap="Antall stenter etter type og måned",fig.width=12,fig.height=8,out.width="4in",echo=FALSE}
...
mst(TabNStentType, params$tableFormat, cap, 0)
...
### `r paste0( range(PCImedStent$ProsedyreDato) , collapse = " til "), ", min. 1 stent (N = ", sum(PCImedStent$Nstents>0))`

```{r Barplot_Nstent_per_Prosedyre,fig.width=12,fig.height=8,out.width="4in",echo=FALSE}
...
```{r TabNstentNameMonth,echo=FALSE,results='asis', eval=FALSE}
...
```{r TabRstentNameMonth,echo=FALSE,results='asis', eval=FALSE}
