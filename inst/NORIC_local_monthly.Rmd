...
Datagrunnlaget for komplikasjoner på kat.lab. gjelder `r AP %>% nrow()` forløp.
...
cap <- paste0("Tabellen under gjelder for ",
              nrow(AP),
              " forløp og er datagrunnlaget for komplikasjoner på kat.lab.",
              " registrert i NORIC ved ", params$hospitalName, " i perioden ",
              rangeProsDato[1], " til ", rangeProsDato[2], ".")
...
```{r FigLabKompl, fig.cap = paste0("Antall komplikasjoner på laboratoriet registrert i NORIC ved ", params$hospitalName, " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], "."), echo=FALSE, fig.pos="H", fig.width = 10, fig.height = 5, fig.align = "center", out.width = "\\textwidth"}
...
cap <- paste0("Tabellen under gjelder for ",
              nrow(AP_avdKomp),
              " primære forløp og er datagrunnlaget for komplikasjoner på ",
              " avdeling registrert i NORIC ved ", params$hospitalName,
              " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], ".")
...
```{r FigAvdKompl, fig.cap = paste0("Antall komplikasjoner på avdelingen registrert i NORIC ved ", params$hospitalName, " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], "."), echo=FALSE, fig.pos = "H", fig.width = 10, fig.height = 5, fig.align = "center", out.width = "\\textwidth"}
