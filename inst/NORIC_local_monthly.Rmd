...
## Komplikasjoner
### Komplikasjoner på kat.lab. for `r params$hospitalName`  i perioden `r rangeProsDato`
...
```{r FigLabKompl, fig.cap = paste0("Antall forløp med komplikasjoner på kat.lab. registrert i NORIC ved ", params$hospitalName, " i perioden ", rangeProsDato, "."), echo=FALSE, fig.pos="H", fig.width = 10, fig.height = 5, fig.align = "center", out.width = "\\textwidth"}
...
Antall stenter per prosedyre ved `r params$hospitalName` registrert i NORIC i perioden `r paste0(rangeProsDato[1], " til ", rangeProsDato[2])`. Antall prosedyrer med minst 1 stent er `r sum(PCImedStent$Nstents>0)`.
