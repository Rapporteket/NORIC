...
Figuren viser antall registrerte komplikasjoner de  siste `r showN` månedene. 
Merk at en pasient kan ha flere typer komplikasjoner
Tabellen viser antall registrerte komplikasjoner per måned. 
...
```{r BarplotNstentPerProsedyre, fig.width = 7, fig.height = 4.5, fig.align = "center", fig.pos = "H", out.width = "\\textwidth", fig.cap = paste0("Antall stenter per prosedyre for ", params$hospitalName, " i perioden ", rangeProsDato, ".")}
