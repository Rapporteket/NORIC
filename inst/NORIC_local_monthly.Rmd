...
```{r AnPPrepare,include=FALSE, eval=FALSE}
...
```{r SOPrepare,include=FALSE, eval=FALSE}
...
```{r APprepare,include=FALSE, eval=FALSE}
...
```{r Daterecodes,include=FALSE, eval=FALSE}
...
```{r subsetting,include=FALSE, eval=FALSE}
...
## Hastegrad
```{r FigNHastegrad,fig.cap="Antall prosedyrer etter hastegrad og måned",fig.width=8,fig.height=4,out.width="\\textwidth", eval=FALSE}
