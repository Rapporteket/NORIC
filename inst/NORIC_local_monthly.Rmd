...
Datagrunnlaget for komplikasjoner på lab gjelder `r AP %>% nrow()` forløp.
...
cap <- paste0("Tabellen under gjelder for ",
              nrow(AP),
              " forløp og er datagrunnlaget for komplikasjoner på laboratoriet",
...
```{r FigLabKompl, fig.cap = paste0("Antall (andel) komplikasjoner på laboratoriet registrert i NORIC ved ", params$hospitalName, " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], "."), echo=FALSE, fig.pos="H", fig.width = 10, fig.height = 5, fig.align = "center", out.width = "\\textwidth"}
...
cap <- paste0("Tabellen under gjelder for ",
              ...
              " laboratoriet registrert i NORIC ved ", params$hospitalName,
              " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], ".")
...
```{r FigAvdKompl, fig.cap = paste0("Antall (andel) komplikasjoner på avdelingen registrert i NORIC ved ", params$hospitalName, " i perioden ", rangeProsDato[1], " til ", rangeProsDato[2], "."), echo=FALSE, fig.pos = "H", fig.width = 10, fig.height = 5, fig.align = "center", out.width = "\\textwidth"}
...
Prosedyrer som ikke er utført med tilknytning til Angio/PCI.
