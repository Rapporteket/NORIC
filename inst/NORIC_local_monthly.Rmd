...
```{r setTitleAndAuthor, echo=FALSE}

params$title <- paste("Norsk register for invasiv kardiologi (NORIC)",
                      "Månedsrapport Angio/PCI", AP$Sykehusnavn[1]) 
params$author <- "Rapporteket"
```
