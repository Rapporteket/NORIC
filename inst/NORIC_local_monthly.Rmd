...
prosRelatertDod <- LabKomplikasjoner[LabKomplikasjoner$VarName == "LabKompProsedyrerelatertDod",]
...
indeksDod <- which(LabKomplikasjoner_uPRD_fig == "LabKompDod")

LabKomplikasjoner_sortert_fig <- rbind(LabKomplikasjoner_uPRD_fig[1:indeksDod-1,],
                               prosRelatertDod,
                               LabKomplikasjoner_uPRD_fig[-(1:indeksDod)-1,])
...
i.labkomp <- rev(order(AvdKomplikasjoner$Prosent))
