...
```{r check_valid_stagedData, include=FALSE, cache=FALSE}

# Staging datasett må være max 2 dager gammelt
...
Rapporten er laget den  `r format(Sys.time(), '%d. %B %Y')`  basert på 
en nasjonal NORIC database der den nyeste registrering er fra 
`r format(periode_data$nyeste_reg, '%d. %B %Y')`. Vi rapporterer kun 
fullstendige måneder her siste registrering inkludert i rapporten er fra
