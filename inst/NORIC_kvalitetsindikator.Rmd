...
header-includes:
  ...
  - \usepackage{float}
  - \usepackage{booktabs}
title:  '`r paste0("Kvalitetsindikatorer fra NORIC.", "Månedsrapport for ",  params$hospitalName)`' 
...
tabVentetid24t <- timeTableMonth %>%
  ...
  dplyr::rename(
    "Måned" = .data$maaned,
    "Antall komplette av datagrunnlaget" = .data$komplette_tekst,
...
Tabell \@ref(tab:tabIndikStemi) viser 
måloppnåelse per måned for `r params$hospitalName` og nasjonalt for behandling
innen 120minutter ved indikasjon STEMI. 
