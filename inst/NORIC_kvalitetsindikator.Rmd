...
cap <- paste0(
  ...
  " data eller færre enn 5 forløp blir markert med stjerne og prosent forløp ", 
  "med ventetid under 24 timer regnes ikke ut for disse. (Målnivå: 50 \\%)")
...
"eller færre enn 5 forløp blir markert med stjerne og prosent forløp med ", 
"ventetid under 72 timer regnes ikke ut for disse. (Målnivå: 80 \\%)"
)
