...
# Datagrunnlag
Datagrunnlaget for denne rapporten er alle fullstendige måneder hittil i år, 
samt hele fjoråret. Siste prosedyredato som er med i opptellingene er 
`r format(periode_data$siste_dato, '%d. %B %Y')`. 


Rapporten er generert med utgangspunkt i NORIC's nasjonale 
database. Den nyeste registreringen overført til Rapporteket er datert
