...
aP <- noric::getPrepApData(
  ...
  fromDate  = as.Date(paste0(periode_data$sisteHeleYear, "-01-01"),
                      format = "%Y-%m-%d"),  
...
Følgende pasienter har _AvdodDato_ før utskrivelses-dato, men 
...
Følgende pasienter har _AvdodDato_ like etter utskrivelses-dato, men 
 er verken registrert _død på lab_, _død på avdeling_ eller
 _død ved utskrivelse_. Vi ber sykehusene om å sjekke disse registreringene. 
