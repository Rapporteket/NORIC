...
con <- DBI::dbUnloadDriver(dbDriver("MySQL"))
con <- null
@ 
...
\begin{frame}[fragile]
<<BoxplotT2TbyPdate,echo=FALSE,fig.height=10,fig.width=16.2,out.width="4in",fig.cap="Dager fra indeks innleggelse til prosedyre etter prosedyremåned for NSTEMI pasienter ved Haukeland universitetssykehus">>=
...
\begin{frame}[fragile]
<<BoxplotT2TbyPdateDirekte,echo=FALSE,fig.height=10,fig.width=16.2,out.width="4in",fig.cap="Dager fra indeks innleggelse til prosedyre etter prosedyremåned for NSTEMI pasienter direkte innlagt ved Haukeland universitetssykehus">>=
...
\begin{frame}[fragile]
<<BoxplotT2TbyPdateOverflyttet,echo=FALSE,fig.height=10,fig.width=16.2,out.width="4in",fig.cap="Dager fra indeks innleggelse til prosedyre etter prosedyremåned for NSTEMI pasienter \\emph{overflyttet} til Haukeland universitetssykehus">>=
# 1.168
boxplot(
    DaysFromIndexAdmissionToProcedure ~ Month ,
    data = HUSNSTEMI ,
