...
#' @name getData
#' @aliases getAp getCt getAk getAkOppf getAnP getAnD getSs getMk getTaviProm getSh getFo getSo getPs getApLight getMergeReportMce getMergeReportPid getMergeReportSegmentId getAngioAssistent getPciAssistent getPI NULL
#' @rdname getData
#' 
#' @export
...
getSo <- function(registryName, fromDate, toDate, singleRow, 
  ...
  query <- noric::querySkjemaoversikt(fromDate = fromDate,
                                      toDate = toDate, 
                                      singleHospital)
