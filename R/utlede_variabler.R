...
#' @param var variable name of the numerical staus-variable with values {-1,0,1}
...
#' utlede_ferdigstilt(., var = SkjemastatusHovedskjema, suffix = "hovedSkjema") %>%
#' utlede_ferdigstilt(., var = SkjemaStatusKomplikasjoner, suffix = "komplikSkjema")
